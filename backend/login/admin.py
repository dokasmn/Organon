...
class ProfessorUserAdmin(admin.ModelAdmin):
    list_display = ('professor_auth_user', 'professor_cpf')  # Colunas a serem exibidas na lista
    search_fields = ('professor_auth_user__username', 'professor_cpf')  # Campos para a busca
