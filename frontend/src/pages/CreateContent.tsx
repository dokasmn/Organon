...
const CreateContent:React.FC = () => {
    ...
    return (
        <>
            <main>
                <section className='pb-7 px-5 sm:px-14' >
                    <TitleSection title="CONTENTS" />
                </section>
                <section className='bg-white-2 px-5 sm:px-14 py-10' >
                    <h3 className=' font-bold text-xl mb-2 ' >Add New Content</h3>
                    <p className='' >Lorem ipsum dolor sit amet, consectetur adipisicing elit.!</p>
                </section>
                <form className='p-5 sm:px-14 flex flex-col gap-5' onSubmit={handleSubmit} >
