...
const CardNewContent:React.FC<CardNewContentProps> = ({subject, content, date, image}) => {
    return (
        <div className='rounded-xl w-52 sm:w-64 h-60 sm:h-72 sm:rounded overflow-hidden bg-white transition-all transform duration-500 hover:scale-105 hover:border-2 hover:border-blue-1 hover:shadow' >
            <div className='' >
